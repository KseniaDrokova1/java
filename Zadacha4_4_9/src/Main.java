...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final Thief thief = new Thief(600);
        final Inspector inspector = new Inspector();
        final Spy spy = new Spy(logger);

        Package pack = new Package("Something valuable", 750);

        MailMessage mailMessage = new MailMessage(AUSTIN_POWERS, "alex", "Hello, Nik!");
        MailPackage mailPackage = new MailPackage(AUSTIN_POWERS, "nik", pack);
    ...
    public static class RealMailService implements Main.MailService {
        @Override
